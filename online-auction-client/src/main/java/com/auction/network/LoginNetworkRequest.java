...
public class LoginNetworkRequest {
     ...
     * @param callback    Bộ lắng nghe phản hồi nhận JsonObject kết quả chạy trên JavaFX Application Thread.
     *                    Nếu lỗi kết nối, callback sẽ nhận JsonObject chứa status = "FAIL" và thông báo tương ứng.
     */
    public static void sendLoginRequestAsync(String username, String password, Consumer<JsonObject> callback) {
        new Thread(() -> {
