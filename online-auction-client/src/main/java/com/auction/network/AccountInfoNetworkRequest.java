...
public class AccountInfoNetworkRequest {
  private static final Logger logger =
      LoggerFactory.getLogger(AccountInfoNetworkRequest.class);
   ...
   * @param callback Bộ lắng nghe nhận JsonObject kết quả phản hồi chạy trên
   *                 JavaFX Application Thread. Nếu lỗi kết nối, callback nhận
   *                 JsonObject chứa status = "FAIL".
   */
  public static void sendUpdateProfileRequestAsync(
      int userId, String username, String email, String phone, Consumer<JsonObject> callback) {
    new Thread(() -> {
