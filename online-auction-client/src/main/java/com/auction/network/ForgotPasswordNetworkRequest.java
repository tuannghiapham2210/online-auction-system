...
public class ForgotPasswordNetworkRequest {
    private static final Logger logger = LoggerFactory.getLogger(ForgotPasswordNetworkRequest.class);
     ...
     */
    public static void sendResetRequestAsync(String username, String contactInfo, String newPassword, BiConsumer<String, String> callback) {
        new Thread(() -> {
