...
/**
 * Dịch vụ điều phối nghiệp vụ cho tính năng thêm mới sản phẩm vào hệ thống đấu giá.
 */
public class AddItemService {

  /**
   * Giao diện callback để nhận kết quả trả về sau khi thực hiện thêm sản phẩm.
   */
  public interface AddItemCallback {
    /**
     * Hàm xử lý kết quả trả về từ tác vụ thêm sản phẩm.
     *
     * @param isSuccess Trạng thái tác vụ (thành công hay thất bại).
     * @param itemId    ID của sản phẩm vừa tạo (trả về -1 nếu thất bại).
     * @param message   Thông báo chi tiết đi kèm.
     */
